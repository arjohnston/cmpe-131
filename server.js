...
const DATABASE_NAME = TEST ? 'cmpe-131-test' : 'cmpe-131'
...
class Server {
  ...
  configureExpress () {
    ...
    this.app.use('/api/dailyEntry', dailyEntry)
    this.app.use('/api/doctorVisit', doctorVisit)
    this.app.use('/api/notification', notification)
